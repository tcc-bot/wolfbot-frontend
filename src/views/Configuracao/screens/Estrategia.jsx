  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit((v) => this.onSubmit(v))}>
        ...
        <Row>
          <Col xs="8">
            <Button type="submit" className="btn-ghost-success" style={{ marginRight: '5px' }}>Salvar Estratégia</Button>
            <Button type="submit" className="btn-ghost-primary" style={{ marginRight: '5px' }}>Editar</Button>
            <Button type="submit" className="btn-ghost-danger">Cancelar</Button>
          </Col>
        </Row>
        <hr />
      </form>
