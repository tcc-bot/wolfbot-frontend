        ...
        <form className="row" onSubmit={handleSubmit((v) => this.onSubmit(v))}>
          <Col xs="12" sm="2">
            ...
            <InputGroup className="lg-2 xs-12 sm-12">
              <Field component={Input} type="text" name="dataInicio" placeholder="Data" className="form-control" />
            </InputGroup>
          </Col>
          <Col xs="12" sm="2">
            <Label>Data da Operação</Label>
            <InputGroup className="mb-2 xs-12 sm-12">
              <Field component={Input} type="text" name="dataFim" placeholder="Data" className="form-control" />
            </InputGroup>
          </Col>
          <Col xs="12" sm="2">
